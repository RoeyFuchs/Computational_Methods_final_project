...
def lr_with_k_fold(train_data_x, train_data_y):
    ...
    plot_train_vald(acc_train, acc_vald, sampels_num, x_label="Training set size (samples)", y_label="Mean Accuracy (%)",
                    title="Mean Accuracy as function of training set size, cross-validation (5)")



def lr_witout_k_fold(train_data_x, train_data_y):
